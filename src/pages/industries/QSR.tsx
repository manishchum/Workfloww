          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            >
              <h1 className="text-5xl md:text-6xl font-bold tracking-tight mb-8 leading-[1.1] text-foreground">
                QSR & Cloud Kitchen Solutions
              </h1>
              <p className="text-xl text-muted-foreground mb-10 leading-relaxed">
                Optimise your kitchen operations and ensure consistent food quality across all your outlets. Lucid provides the digital tools needed for recipe compliance, food safety audits, and rapid staff training in high-pressure environments.
              </p>
            ...
            >
              <div className="relative rounded-[2rem] overflow-hidden border border-border shadow-2xl bg-white p-2">
                <img
                  src="https://picsum.photos/seed/qsr/1200/800"
      ...
      <section className="py-24 bg-secondary/30">
        <div className="container mx-auto px-6">
          <div className="max-w-3xl mx-auto text-center mb-16">
            <h2 className="text-3xl md:text-4xl font-bold mb-6">Kitchen Efficiency at Scale</h2>
            <p className="text-lg text-muted-foreground">
              Lucid helps QSR brands and cloud kitchens maintain high standards while scaling rapidly.
            </p>
          </div>
            ...
            {[
              {
                ...
                description: "Digital recipe cards with photos and videos to ensure consistent food preparation."
              },
              {
                title: "Food Safety Audits",
                description: "Automated checklists for temperature logs, hygiene, and safety standards."
              },
              {
                title: "Rapid Onboarding",
                description: "Get new kitchen staff up to speed in hours with mobile-first training modules."
              },
              {
                title: "Waste Management",
                description: "Track and reduce food waste with real-time reporting and analytics."
              },
              {
                title: "Equipment Maintenance",
                description: "Schedule and record preventative maintenance for all kitchen equipment."
              },
              {
                title: "Shift Handover",
                description: "Streamline communication between shifts with digital logs and task lists."
              }
            ].map((feature, i) => (
              <motion.div
                key={i}
