          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            >
              ...
              <p className="text-xl text-muted-foreground mb-10 leading-relaxed">
                Ensure compliance and drive sales in highly regulated environments. Lucid helps you deliver mandatory regulatory training, automate policy updates, and provide your frontline agents with the latest product information and sales tools.
              </p>
      ...
      <section className="py-24 bg-secondary/30">
        <div className="container mx-auto px-6">
          <div className="max-w-3xl mx-auto text-center mb-16">
            <h2 className="text-3xl md:text-4xl font-bold mb-6">Compliance & Performance</h2>
            <p className="text-lg text-muted-foreground">
              Lucid provides the security and reliability needed for the financial services industry.
            </p>
          </div>
            ...
            {[
              {
                ...
                description: "Deliver and track mandatory compliance training with full audit trails."
              },
              {
                title: "Policy Updates",
                description: "Instantly share policy changes and ensure every agent has read and understood them."
              },
              {
                title: "Product Knowledge",
                description: "Keep your team updated on complex financial products with bite-sized learning."
              },
              {
                title: "Sales Enablement",
                description: "Provide agents with the latest sales scripts, brochures, and tools on their mobile devices."
              },
              {
                title: "Secure Communication",
                description: "Share sensitive information through encrypted, company-controlled channels."
              },
              {
                title: "Audit Readiness",
                description: "Maintain comprehensive records of all training and communication for regulatory audits."
              }
            ].map((feature, i) => (
              <motion.div
                key={i}
          ...
          <div className="bg-primary rounded-[3rem] p-12 md:p-20 text-center relative overflow-hidden">
            <div className="relative z-10 max-w-3xl mx-auto">
              <h2 className="text-4xl md:text-5xl font-bold text-primary-foreground mb-8">
                Ready to drive compliance and sales?
              </h2>
