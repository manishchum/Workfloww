          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            >
              ...
              <p className="text-xl text-muted-foreground mb-10 leading-relaxed">
                Boost agent productivity and ensure high-quality customer interactions. Lucid helps you deliver rapid product training, automate quality assurance, and provide real-time guidance to your contact centre agents, whether they are in-office or remote.
              </p>
            ...
            >
              <div className="relative rounded-[2rem] overflow-hidden border border-border shadow-2xl bg-white p-2">
                <img
                  src="https://picsum.photos/seed/bpo/1200/800"
                  alt="Contact Centre Operations"
      ...
      <section className="py-24 bg-secondary/30">
        <div className="container mx-auto px-6">
          <div className="max-w-3xl mx-auto text-center mb-16">
            <h2 className="text-3xl md:text-4xl font-bold mb-6">Agent Excellence at Scale</h2>
            <p className="text-lg text-muted-foreground">
              Lucid provides the tools needed to manage large-scale BPO operations with precision and efficiency.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {[
              {
                title: "Rapid Product Training",
                description: "Get agents up to speed on new products and features in record time."
              },
              {
                title: "Real-time Guidance",
                description: "Provide agents with the information they need, exactly when they need it."
              },
              {
                title: "Automated QA",
                description: "Streamline quality assurance processes with digital checklists and reporting."
              },
              {
                title: "Remote Agent Support",
                description: "Ensure remote agents have access to the same training and resources as in-office staff."
              },
              {
                title: "Compliance Management",
                description: "Track and record agent compliance with industry regulations and company policies."
              },
              {
                title: "Performance Analytics",
                description: "Gain deep insights into agent performance and identify areas for improvement."
              }
            ].map((feature, i) => (
              <motion.div
                key={i}
