...
const PROBLEM_FIX_PAIRS = [
	{
		...
		roi: "ROI: Quality Consistency → ↓ SOP Deviation Rate",
	},
	{
		...
		roi: "ROI: Shift Continuity → ↓ First-Hour Incidents",
	},
	{
		...
		roi: "ROI: Audit Readiness → Zero Repeat Findings",
	},
	{
		...
		roi: "ROI: Regulatory Compliance → ↓ Audit Risk",
	},
	{
		...
		roi: "ROI: Safety & Liability → ↓ LTIFR Risk",
	},
];
...
const WHO_USES = [
	{
		role: "Plant Head",
		detail:
			"Line-by-line SOP adherence, shift pattern, deviation root cause, weekly.",
	},
	{
		role: "Quality Head",
		detail:
			"Deviation trend by line, root cause breakdown, audit-ready evidence on demand.",
	},
	{
		role: "Manufacturing Head",
		detail:
			"Cross-plant execution view, which plants are improving, which are stuck.",
	},
	{
		role: "EHS Head",
		detail:
			"Safety protocol delivery verified, incident investigation ready, LTIFR signal visible.",
	},
];
			...
			<section className="section" id="problem">
				<div className="container space-y-10">
					...
					{PROBLEM_FIX_PAIRS.map((pair) => (
						<div key={pair.label} className="problem-row">
							<div className="problem-card">
								<div className="problem-eyebrow">{pair.label}</div>
								<h4>{pair.problemTitle}</h4>
								<p className="hero-copy" style={{ marginTop: 12 }}>{pair.problemBody}</p>
							</div>
							<div className="fix-card">
								<div className="fix-eyebrow">Fix</div>
								<h4>{pair.fixTitle}</h4>
								<p className="hero-copy" style={{ marginTop: 12, color: "rgba(255,255,255,0.7)" }}>{pair.fixBody}</p>
								<div className="roi-tag">
									<strong>{pair.roi}</strong>
								</div>
							</div>
						</div>
					))}
				...
				<div className="container mx-auto px-6 text-white">
					...
					<div className="mt-10 rounded-3xl border border-slate-800 bg-[#111827] p-8">
									...
									<div className="h-40 w-full">
										<svg viewBox="0 0 320 140" className="w-full h-full">
											<polyline
												...
												stroke="#A32D2D"
												strokeWidth="3"
												points="10,40 70,38 130,36 190,35 250,34 310,80"
											/>
											<polyline
												fill="none"
												stroke="#1D9E75"
												strokeWidth="2"
												strokeDasharray="6 6"
												points="10,110 70,112 130,108 190,111 250,109 310,108"
											/>
						...
						<div className="mt-8 rounded-2xl border border-slate-800 bg-[#0b0f16] p-5 text-sm text-slate-300">
							A Plant Head reading this doesn't need a quality review meeting to know what to do. <span className="text-[#6357d4]">Line C Night shift. 4 weeks straight. 90% knowledge gap. One targeted sprint fixes it before next Monday.</span>
						</div>
					</div>
				</div>
			</section>
