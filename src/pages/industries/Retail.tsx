          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            >
              <h1 className="text-5xl md:text-6xl font-bold tracking-tight mb-8 leading-[1.1] text-foreground">
                Retail Solutions built for Frontline teams
              </h1>
              <p className="text-xl text-muted-foreground mb-10 leading-relaxed">
                Empower your retail workforce with the tools they need to deliver exceptional customer experiences. From product knowledge to store operations, Lucid helps you drive sales and operational excellence across all your locations.
              </p>
            ...
            >
              <div className="relative rounded-[2rem] overflow-hidden border border-border shadow-2xl bg-white p-2">
                <img
                  src="https://picsum.photos/seed/retail/1200/800"
      ...
      <section className="py-24 bg-secondary/30">
        <div className="container mx-auto px-6">
          <div className="max-w-3xl mx-auto text-center mb-16">
            <h2 className="text-3xl md:text-4xl font-bold mb-6">Drive Retail Excellence</h2>
            <p className="text-lg text-muted-foreground">
              Lucid provides a comprehensive suite of tools tailored for the unique challenges of the retail industry.
            </p>
          </div>
            ...
            {[
              {
                ...
                description: "Ensure every associate is an expert on your products with bite-sized training."
              },
              {
                title: "Visual Merchandising",
                description: "Share guidelines and verify store displays with real-time photo audits."
              },
              {
                title: "Customer Service",
                description: "Train your team on service standards and handle customer feedback effectively."
              },
              {
                title: "Inventory Management",
                description: "Streamline stock checks and reporting with mobile-first operational tools."
              },
              {
                title: "Sales Incentives",
                description: "Motivate your team with transparent rewards and recognition programs."
              },
              {
                title: "Store Compliance",
                description: "Automate safety checks and policy updates across all your retail outlets."
              }
            ].map((feature, i) => (
              <motion.div
                key={i}
