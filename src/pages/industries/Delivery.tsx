          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            >
              ...
              <p className="text-xl text-muted-foreground mb-10 leading-relaxed">
                Empower your delivery partners with the knowledge and tools they need to provide safe, efficient, and high-quality service. Lucid helps you onboard at scale, ensure safety compliance, and maintain service standards across your entire fleet.
              </p>
      ...
      <section className="py-24 bg-secondary/30">
        <div className="container mx-auto px-6">
          <div className="max-w-3xl mx-auto text-center mb-16">
            <h2 className="text-3xl md:text-4xl font-bold mb-6">Efficiency in Motion</h2>
            <p className="text-lg text-muted-foreground">
              Lucid provides the digital infrastructure needed to manage a large, distributed delivery workforce.
            </p>
          </div>
            ...
            {[
              {
                ...
                description: "Onboard thousands of delivery partners quickly with automated digital training."
              },
              {
                title: "Safety Training",
                description: "Deliver mandatory road safety and handling training directly to mobile devices."
              },
              {
                title: "Service Standards",
                description: "Ensure consistent customer interactions with clear, accessible guidelines."
              },
              {
                title: "Compliance Checks",
                description: "Automate document verification and vehicle safety checks."
              },
              {
                title: "Performance Feedback",
                description: "Provide real-time feedback and coaching based on delivery metrics."
              },
              {
                title: "Incentive Programs",
                description: "Drive performance with transparent rewards and recognition for top partners."
              }
            ].map((feature, i) => (
              <motion.div
                key={i}
          ...
          <div className="bg-primary rounded-[3rem] p-12 md:p-20 text-center relative overflow-hidden">
            <div className="relative z-10 max-w-3xl mx-auto">
              <h2 className="text-4xl md:text-5xl font-bold text-primary-foreground mb-8">
                Ready to empower your delivery fleet?
              </h2>
