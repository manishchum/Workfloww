          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            >
              <h1 className="text-5xl md:text-6xl font-bold tracking-tight mb-8 leading-[1.1] text-foreground">
                Supermarket & Grocery Solutions
              </h1>
              <p className="text-xl text-muted-foreground mb-10 leading-relaxed">
                Manage complex supermarket operations with ease. Lucid helps you digitise SOPs, ensure food safety compliance, and train large frontline teams across multiple departments. Drive efficiency from the warehouse to the checkout counter.
              </p>
            ...
            >
              <div className="relative rounded-[2rem] overflow-hidden border border-border shadow-2xl bg-white p-2">
                <img
                  src="https://picsum.photos/seed/supermarket/1200/800"
                  alt="Supermarket Operations"
      ...
      <section className="py-24 bg-secondary/30">
        <div className="container mx-auto px-6">
          <div className="max-w-3xl mx-auto text-center mb-16">
            <h2 className="text-3xl md:text-4xl font-bold mb-6">Efficiency in Every Aisle</h2>
            <p className="text-lg text-muted-foreground">
              Lucid provides the tools needed to manage the high-volume, high-complexity environment of modern grocery retail.
            </p>
          </div>
            ...
            {[
              {
                ...
                description: "Digitise standard operating procedures for produce, deli, bakery, and more."
              },
              {
                title: "Freshness Audits",
                description: "Automate quality checks and expiry date tracking to reduce shrinkage."
              },
              {
              ...
              },
              {
                ...
                description: "Enable employees to work across departments with flexible mobile learning."
              },
              {
                title: "Promotion Execution",
                description: "Verify that in-store promotions and displays are correctly implemented."
              },
              {
                title: "Inventory Accuracy",
                description: "Streamline stock counting and reporting with easy-to-use mobile tools."
              }
            ].map((feature, i) => (
              <motion.div
                key={i}
          ...
          <div className="bg-primary rounded-[3rem] p-12 md:p-20 text-center relative overflow-hidden">
            <div className="relative z-10 max-w-3xl mx-auto">
              <h2 className="text-4xl md:text-5xl font-bold text-primary-foreground mb-8">
                Ready to optimise your grocery operations?
              </h2>
