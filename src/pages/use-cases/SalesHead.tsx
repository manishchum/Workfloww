          ...
          <div className="grid grid-cols-1 lg:grid-cols-[1.1fr_0.9fr] gap-16 items-center">
            <div>
              ...
              <p className="text-base text-slate-600 mt-4 max-w-xl">
                Drive a <span className="font-semibold text-slate-900">+17%</span> close rate lift, keep launch readiness at <span className="font-semibold text-slate-900">88</span>, and surface the <span className="font-semibold text-slate-900">6</span> locations that leak revenue first.
              </p>
            ...
            <div className="bg-white border border-slate-200 rounded-3xl shadow-xl p-6">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <h3 className="text-2xl font-bold mt-2">Product knowledge by role</h3>
                </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-[1.05fr_0.95fr] gap-16 items-center">
            <div>
              ...
              <ul className="mt-6 space-y-3 text-slate-700">
                <li>Launch readiness score holds at <span className="font-semibold text-slate-900">88</span>.</li>
                <li><span className="font-semibold text-slate-900">6</span> locations are below target and bleeding close rate.</li>
            ...
            <div className="bg-white border border-slate-200 rounded-3xl shadow-xl p-6">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <h3 className="text-2xl font-bold mt-2">Regional score</h3>
                </div>
                <div className="text-right">
                  <div className="text-3xl font-bold text-[#6357d4]">88</div>
                  <p className="text-xs text-amber-600 font-semibold">6 locations low</p>
                </div>
              </div>
              <div className="mt-6 space-y-4">
                {LAUNCH_LOCATIONS.map((location) => (
                  <div key={location.name} className={`rounded-2xl border px-4 py-3 ${statusStyles[location.status]}`}>
                    <div className="flex items-center justify-between">
            ...
            <div className="bg-white border border-slate-200 rounded-3xl shadow-xl p-6">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <h3 className="text-xl font-bold mt-2">Launch execution today</h3>
                </div>
              ...
              <div className="mt-6 space-y-3">
                <div className="rounded-xl border border-slate-200 bg-slate-50 px-4 py-3 flex items-center justify-between text-sm">
                  <span className="text-slate-600">WhatsApp delivery</span>
                ...
                <div className="rounded-xl border border-slate-200 bg-slate-50 px-4 py-3 flex items-center justify-between text-sm">
                  <span className="text-slate-600">Quiz passed</span>
                  <span className="font-semibold text-slate-900">71%</span>
                </div>
              </div>

              <div className="mt-6 bg-amber-50 border border-amber-100 text-amber-700 text-sm font-semibold rounded-xl px-4 py-3">
      ...
      <section className="bg-slate-900 text-white">
        <div className="container mx-auto px-6 py-20">
          <div className="flex flex-col lg:flex-row items-start lg:items-center justify-between gap-8">
            ...
            <Button size="lg" className="h-12 px-6 rounded-xl text-base font-semibold bg-white text-slate-900 hover:bg-slate-100">
              Book a Demo
            </Button>
          </div>
        </div>
