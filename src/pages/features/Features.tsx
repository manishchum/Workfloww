...
//       <Helmet>
//         <title>Features – Sales Enablement Platform | Lucid by Workfloww.AI</title>
//         <meta name="description" content="Explore Lucid's four pillars — Sales Team readiness, Sales Tools, Execution tracking, and Content Engine. Built for frontline sales teams across FMCG, QSR, insurance and more." />
//         <link rel="canonical" href="https://www.workfloww.ai/features" />
//       </Helmet>
//       {/* Tab Switcher */}
//       <div className="bg-slate-50 py-12 px-8">
//         <div className="lucid-container">
