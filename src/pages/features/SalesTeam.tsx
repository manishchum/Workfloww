...
const SalesTeam = () => {
  ...
  return (
    <div className="w-full bg-white">
      {/* ===== 1. HERO SECTION ===== */}
     <section className="relative w-full min-h-[95vh] px-4 md:px-8 lg:px-12 flex items-center overflow-hidden">
  <div className="max-w-7xl mx-auto w-full">
    <div className="grid grid-cols-1 md:grid-cols-2 gap-12 lg:gap-20 items-center pt-12 md:pt-16">

      {/* Left */}
      <div className="flex flex-col justify-center gap-8 max-w-2xl">
        <h1
          className="text-4xl md:text-5xl lg:text-7xl font-black text-gray-900 leading-[0.95]"
...
<section className="w-full py-8 md:py-10 px-4 md:px-8 lg:px-12 bg-white">
  <div className="max-w-7xl mx-auto">
    <div className="grid grid-cols-1 md:grid-cols-2 gap-14 items-center">
      ...
      <div className="flex flex-col gap-6">
        ...
        <h2
          className="text-3xl md:text-5xl font-black text-gray-900 leading-[1.1]"
          style={{ fontFamily: "DM Sans, sans-serif" }}
        >
      ...
      {/* ===== 3. STAT STRIP ===== */}
      <section className="w-full py-12 md:py-16 px-4 md:px-8 lg:px-12 bg-gray-50">
        <div className="max-w-7xl mx-auto">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 md:gap-6">
            ...
            <div className="bg-white p-6 rounded-lg border border-gray-200 text-center">
              ...
              <p className="text-gray-700 text-sm font-semibold mt-2">Sprint Completion Rate</p>
            </div>
            ...
            <div className="bg-white p-6 rounded-lg border border-gray-200 text-center">
              ...
              <p className="text-gray-700 text-sm font-semibold mt-2">Knowledge Retention vs Classroom</p>
            </div>
            ...
            <div className="bg-white p-6 rounded-lg border border-gray-200 text-center">
              ...
              <p className="text-gray-700 text-sm font-semibold mt-2">Avg Time to Field Readiness</p>
            </div>
            ...
            <div className="bg-white p-6 rounded-lg border border-gray-200 text-center">
              ...
              <p className="text-gray-700 text-sm font-semibold mt-2">Drop in Onboarding Errors</p>
            </div>
          </div>
        </div>
      </section>
...
<section className="w-full py-8 md:py-10 px-4 md:px-8 lg:px-12 bg-gray-50">
  <div className="max-w-7xl mx-auto">
    <div className="grid grid-cols-1 md:grid-cols-2 gap-14 items-center">
...
<section className="w-full py-8 md:py-10 px-4 md:px-8 lg:px-12 bg-white">
  <div className="max-w-7xl mx-auto">
    <div className="grid grid-cols-1 md:grid-cols-2 gap-14 items-center">
     ...
     {/* ===== DARK STATS STRIP ===== */}
<section
  className="w-full py-10 md:py-14 lg:py-16 px-4 md:px-8 lg:px-12"
  style={{ backgroundColor: "#0f1117" }}
>
  <div className="max-w-7xl mx-auto">
    <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-10 md:gap-8 lg:gap-12">
      ...
      {/* ===== MORE TEAM FEATURES ===== */}
<section className="w-full py-8 md:py-12 lg:py-14 px-4 md:px-8 lg:px-12 bg-gray-50">
  <div className="max-w-7xl mx-auto">
    ...
    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 lg:gap-8">
      ...
      {/* Card 1 */}
      <div className="bg-white rounded-3xl border border-gray-200 p-7 hover:shadow-xl transition-all duration-300 hover:-translate-y-1">
        <div
      ...
      {/* ===== 11. CTA BANNER ===== */}
      {/* ===== FINAL CTA ===== */}
<section className="w-full py-8 md:py-12 lg:py-14 px-4 md:px-8 lg:px-12">
