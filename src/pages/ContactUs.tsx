                ...
                <form onSubmit={handleContactSubmit} className="space-y-6">
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div className="space-y-2">
                      ...
                      <Input id="firstName" className="bg-white border-slate-200 text-slate-900 h-12" placeholder="Jane" required />
                    </div>
                    <div className="space-y-2">
                      <Label htmlFor="lastName" className="text-slate-700">Last Name</Label>
                      <Input id="lastName" className="bg-white border-slate-200 text-slate-900 h-12" placeholder="Doe" required />
                    </div>
                  </div>
                  ...
                  <div className="space-y-2">
                    <Label htmlFor="message" className="text-slate-700">Key Execution Challenge</Label>
                    <Textarea id="message" className="bg-white border-slate-200 text-slate-900 min-h-[120px]" placeholder="Briefly describe what you're tracking currently..." required />
                  </div>

                  <Button type="submit" className="w-full h-16 rounded-2xl lucid-cta text-lg font-bold shadow-2xl shadow-blue-600/30">
                    Apply Now <ArrowRight className="ml-2 w-5 h-5" />
                  </Button>

                  <p className="text-center text-[10px] text-slate-500 uppercase tracking-widest pt-4">
                    Typically Live in 48-72 hours post-onboarding
                  </p>
                </form>
              </div>
            </motion.div>
