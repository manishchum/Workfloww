    ...
    <div className="pt-24">
                ...
                <Card className="border-none shadow-sm">
                  <CardContent className="pt-6">
                    <div className="w-10 h-10 bg-blue-100 rounded-lg flex items-center justify-center mb-4">
                      <Filter className="w-6 h-6 lh-accent-text" />
                    </div>
                    <h3 className="font-bold mb-2 lh-text-ink">Auto-Categorization</h3>
                    <p className="text-sm lh-text-muted">AI-driven sorting of tickets into predefined categories.</p>
                  </CardContent>
                </Card>
                <Card className="border-none shadow-sm">
                  <CardContent className="pt-6">
                    ...
                    <h3 className="font-bold mb-2 lh-text-ink">Instant Assignment</h3>
                    <p className="text-sm lh-text-muted">Tickets are assigned to the right team in real-time.</p>
                  </CardContent>
                </Card>
              </div>
            </div>
            ...
            <div className="lg:w-1/2 order-1 lg:order-2">
              ...
              <div className="space-y-6">
                <div className="flex gap-4">
                  ...
                  <div>
                    <h4 className="font-bold lh-text-ink">In-Ticket Chat</h4>
                    <p className="lh-text-muted">Direct communication between the reporter and the resolver.</p>
                  </div>
                </div>
                <div className="flex gap-4">
                  ...
                  <div>
                    <h4 className="font-bold lh-text-ink">SLA Monitoring</h4>
                    <p className="lh-text-muted">Ensure every ticket is resolved within the target timeframe.</p>
                  </div>
                </div>
              </div>
            </div>
      ...
      <section style={{ padding: "2.5rem 1.25rem", background: "#f8fafc" }} className="">
        <div style={{ maxWidth: "1100px", margin: "0 auto", width: "100%" }} className="text-center">
          <h2 className="text-3xl font-bold mb-16 lh-text-ink">Sub Features of Ticketing</h2>
